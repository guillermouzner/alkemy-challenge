...
/**
   ...
   * `prisma.transactionCategory`: Exposes CRUD operations for the **TransactionCategory** model.
    ...
    * ```
    */
  get transactionCategory(): Prisma.TransactionCategoryDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type TransactionCategoryCountOutputTypeGetPayload<
    S extends boolean | null | undefined | TransactionCategoryCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? TransactionCategoryCountOutputType
    : S extends undefined
    ? never
    : S extends TransactionCategoryCountOutputTypeArgs
    ?'include' extends U
    ? TransactionCategoryCountOutputType 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof TransactionCategoryCountOutputType ? TransactionCategoryCountOutputType[P] : never
  } 
    : TransactionCategoryCountOutputType
  : TransactionCategoryCountOutputType
   ...
   */
  export type TransactionCategoryCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the TransactionCategoryCountOutputType
     * 
    **/
    select?: TransactionCategoryCountOutputTypeSelect | null
  }
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'Wallet' ? WalletGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Wallet' ? WalletGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
  ...
  export type WalletGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends '_count' ? WalletCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        ...
        P extends '_count' ? WalletCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Wallet ? Wallet[P] : never
  } 
    : Wallet
  : Wallet
  ...
  export class Prisma__WalletClient<T, Null = never> implements PrismaPromise<T> {
    ...
    transactions<T extends TransactionFindManyArgs = {}>(args?: Subset<T, TransactionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Transaction>| Null>, PrismaPromise<Array<TransactionGetPayload<T>>| Null>>;
  ...
  export type TransactionSelect = {
    ...
    date?: boolean
    info?: boolean
    category?: boolean | TransactionCategoryArgs
  ...
  export type TransactionGetPayload<
    ...
    ? Transaction  & {
    [P in TrueKeys<S['include']>]:
        P extends 'category' ? TransactionCategoryGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'wallet' ? WalletGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'category' ? TransactionCategoryGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'wallet' ? WalletGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Transaction ? Transaction[P] : never
  } 
    : Transaction
  : Transaction
  ...
  export class Prisma__TransactionClient<T, Null = never> implements PrismaPromise<T> {
    ...
    category<T extends TransactionCategoryArgs = {}>(args?: Subset<T, TransactionCategoryArgs>): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory | Null>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T> | Null>>;
  ...
  export type TransactionCategoryAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<TransactionCategoryOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type TransactionCategoryGroupByArgs = {
    where?: TransactionCategoryWhereInput
    orderBy?: Enumerable<TransactionCategoryOrderByWithAggregationInput>
    by: Array<TransactionCategoryScalarFieldEnum>
  ...
  type GetTransactionCategoryGroupByPayload<T extends TransactionCategoryGroupByArgs> = PrismaPromise<
    Array<
      PickArray<TransactionCategoryGroupByOutputType, T['by']> &
        {
  ...
  export type TransactionCategorySelect = {
    ...
    name?: boolean
    Transactions?: boolean | TransactionFindManyArgs
    _count?: boolean | TransactionCategoryCountOutputTypeArgs
  }
  ...
  export type TransactionCategoryGetPayload<
    S extends boolean | null | undefined | TransactionCategoryArgs,
    U = keyof S
      > = S extends true
        ? TransactionCategory
    : S extends undefined
    ? never
    : S extends TransactionCategoryArgs | TransactionCategoryFindManyArgs
    ?'include' extends U
    ? TransactionCategory  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Transactions' ? Array < TransactionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? TransactionCategoryCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Transactions' ? Array < TransactionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? TransactionCategoryCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof TransactionCategory ? TransactionCategory[P] : never
  } 
    : TransactionCategory
  : TransactionCategory


  type TransactionCategoryCountArgs = Merge<
    Omit<TransactionCategoryFindManyArgs, 'select' | 'include'> & {
      select?: TransactionCategoryCountAggregateInputType | true
    }
  >

  export interface TransactionCategoryDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends TransactionCategoryFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, TransactionCategoryFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'TransactionCategory'> extends True ? CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>> : CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory | null, null>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T> | null, null>>
     ...
     * })
    **/
    findFirst<T extends TransactionCategoryFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, TransactionCategoryFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'TransactionCategory'> extends True ? CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>> : CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory | null, null>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T> | null, null>>
    ...
    **/
    findMany<T extends TransactionCategoryFindManyArgs>(
      args?: SelectSubset<T, TransactionCategoryFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<TransactionCategory>>, PrismaPromise<Array<TransactionCategoryGetPayload<T>>>>
    ...
    **/
    create<T extends TransactionCategoryCreateArgs>(
      args: SelectSubset<T, TransactionCategoryCreateArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>
    ...
    **/
    createMany<T extends TransactionCategoryCreateManyArgs>(
      args?: SelectSubset<T, TransactionCategoryCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    delete<T extends TransactionCategoryDeleteArgs>(
      args: SelectSubset<T, TransactionCategoryDeleteArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>
    ...
    **/
    update<T extends TransactionCategoryUpdateArgs>(
      args: SelectSubset<T, TransactionCategoryUpdateArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>
    ...
    **/
    deleteMany<T extends TransactionCategoryDeleteManyArgs>(
      args?: SelectSubset<T, TransactionCategoryDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends TransactionCategoryUpdateManyArgs>(
      args: SelectSubset<T, TransactionCategoryUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends TransactionCategoryUpsertArgs>(
      args: SelectSubset<T, TransactionCategoryUpsertArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>

    /**
     * Find one TransactionCategory that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
    findUniqueOrThrow<T extends TransactionCategoryFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, TransactionCategoryFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>
    ...
    **/
    findFirstOrThrow<T extends TransactionCategoryFindFirstOrThrowArgs>(
      args?: SelectSubset<T, TransactionCategoryFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__TransactionCategoryClient<TransactionCategory>, Prisma__TransactionCategoryClient<TransactionCategoryGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends TransactionCategoryAggregateArgs>(args: Subset<T, TransactionCategoryAggregateArgs>): PrismaPromise<GetTransactionCategoryAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, TransactionCategoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTransactionCategoryGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__TransactionCategoryClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * TransactionCategory base type for findUnique actions
   */
  export type TransactionCategoryFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the TransactionCategory
     * 
    **/
    select?: TransactionCategorySelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: TransactionCategoryInclude | null
    /**
   ...
   */
  export interface TransactionCategoryFindUniqueArgs extends TransactionCategoryFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * TransactionCategory base type for findFirst actions
   */
  export type TransactionCategoryFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the TransactionCategory
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<TransactionCategoryScalarFieldEnum>
  }

  /**
   * TransactionCategory: findFirst
   */
  export interface TransactionCategoryFindFirstArgs extends TransactionCategoryFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  export type TransactionCategoryCreateManyArgs = {
     ...
     * 
    **/
    data: Enumerable<TransactionCategoryCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   */
  export type TransactionCategoryFindUniqueOrThrowArgs = TransactionCategoryFindUniqueArgsBase
      

  /**
   * TransactionCategory: findFirstOrThrow
   */
  export type TransactionCategoryFindFirstOrThrowArgs = TransactionCategoryFindFirstArgsBase
  ...
  export type TransactionWhereInput = {
    ...
    transactionCategoryId?: IntFilter | number
  ...
  export type TransactionScalarWhereWithAggregatesInput = {
    ...
    transactionCategoryId?: IntWithAggregatesFilter | number
    walletId?: IntWithAggregatesFilter | number
  }

  export type TransactionCategoryWhereInput = {
    AND?: Enumerable<TransactionCategoryWhereInput>
    OR?: Enumerable<TransactionCategoryWhereInput>
    NOT?: Enumerable<TransactionCategoryWhereInput>
    id?: IntFilter | number
  ...
  export type TransactionCategoryWhereUniqueInput = {
    id?: number
    name?: string
  }
  ...
  export type TransactionCategoryScalarWhereWithAggregatesInput = {
    AND?: Enumerable<TransactionCategoryScalarWhereWithAggregatesInput>
    OR?: Enumerable<TransactionCategoryScalarWhereWithAggregatesInput>
    NOT?: Enumerable<TransactionCategoryScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
  ...
  export type TransactionUncheckedUpdateInput = {
    ...
    date?: DateTimeFieldUpdateOperationsInput | Date | string
    info?: NullableStringFieldUpdateOperationsInput | string | null
    transactionCategoryId?: IntFieldUpdateOperationsInput | number
